...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MSClusterStatus) DeepCopyInto(out *MSClusterStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MSClusterStatus.
func (in *MSClusterStatus) DeepCopy() *MSClusterStatus {
	if in == nil {
		return nil
	}
	out := new(MSClusterStatus)
	in.DeepCopyInto(out)
	return out
}
