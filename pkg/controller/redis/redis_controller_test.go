...
func TestRedisControllerAddStatefulset(t *testing.T) {
	...
	type testcase struct {
		name              string
		initSet           func(*v1alpha1.Redis) *apps.StatefulSet
	...
	tests := []testcase{
		{
			name: "normal",
			initSet: func(rc *v1alpha1.Redis) *apps.StatefulSet {
...
func newStatefuSet(rc *v1alpha1.Redis) *apps.StatefulSet {
	return &apps.StatefulSet{
		...
		Spec: apps.StatefulSetSpec{
			Replicas: &rc.Spec.Redis.Members,
		},
	}
}
